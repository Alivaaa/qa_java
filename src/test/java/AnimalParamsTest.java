...
public class AnimalParamsTest {
    ...
    @Parameterized.Parameters(name = "Animal kind: {0}; Expected result: {1}")
    ...
    public void getFoodReturnsValidList() throws Exception {
        ...
        assertEquals("animal.getFood() должен возвращать валидный список еды", expectedResult, actualResult);
    }
}
